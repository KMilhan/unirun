...
2. `pytest`: execute the project’s unit/integration suites (pytest also runs the
   legacy unittest modules).
3. `make contract-versions`: run CPython’s `test_asyncio` /
   `test_concurrent_futures` suites across Python 3.11–3.14 with the compat
